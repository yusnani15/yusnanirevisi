...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_berkelakuan_baik where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
			...
			<?php include("kop_surat.php");?>
				<table width="590" border="0" align="center" cellpadding="3" cellspacing="3">
				  <tr>
					...
					<center>
						<u><b>SURAT KETERANGAN BERKELAKUAN BAIK</b></u><br>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="6">
							<tr>
								...
								<td width="auto" align="justify">
									Nama tersebut diatas adalah benar-benar penduduk Nagori Perasmian Kecamatan Dolol Silau Kabupaten Simalungun
								</td>
							</tr>
							<tr>
								<td valign="top">2.</td>
								<td  align="justify">
									Turut kami terangkan bahwa nama tersebut diatas sepanjang pengetahuan kami <b>Benar Berkelakuan Baik</b> dan 
									tidak pernah berurusan dengan pihak kepolisian karena tindak kejahatan/kriminal serta tidak terikat dengan narkoba
									dan tidak terkait dengan ormas yang tertentangan dengan Pancasila dan Undang-Undang Dasar 1945.
								</td>
							</tr>
						</table>
						<br>
						Demikian surat keterangan ini diperbuat dengan sebenarnya dan diberikan kepada yang bersangkutan untuk dipergunakan seperlunya.
						<br>
