...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_pindah where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
...
if (mysqli_num_rows($query_surat)>0){
	...
	$alamat_pindah=$data_surat["alamat_pindah"];
			...
			<?php include("kop_surat.php");?>
				<table width="590" border="0" align="center" cellpadding="3" cellspacing="3">
				  <tr>
					...
					<center>
						<u><b>SURAT KETERANGAN PINDAH</b></u><br>
