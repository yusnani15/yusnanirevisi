...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
...
if (mysqli_num_rows($query_surat)>0){
	...
	$lokasi_hilang=$data_surat["lokasi_hilang"];
			...
			<?php include("kop_surat.php");?>
				<table width="590" border="0" align="center" cellpadding="3" cellspacing="3">
				  <tr>
					...
					<center>
						<u><b>SURAT KETERANGAN PENGGANTI KTP</b></u><br>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="6">
							...
							<tr>
								<td valign="top">2.</td>
								<td  align="justify">
									Turut diterangkan bahwa Katu Tanda Penduduk (KTP) untuk nama tersebut diatas benar-benar hilang di wilayah <?php echo $lokasi_hilang; ?>.
								</td>
							</tr>
						</table>
						<br>
