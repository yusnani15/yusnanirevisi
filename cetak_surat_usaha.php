...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_usaha where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
...
if (mysqli_num_rows($query_surat)>0){
	...
	$nama_usaha=$data_surat["nama_usaha"];
					...
					<center>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="6">
							<tr>
								...
								<td width="auto" align="justify"  colspan="2">
							...
							<tr>
								...
								<td  align="justify" colspan="2">
									Dan dapat kami tambahkan bahwa atas pengakuan nama tersebut dan sepanjang pengetahuan kami ia benar-benar mempunai/memiliki usaha :<br>
								</td>
							</tr>
							<tr>
								<td valign="top" colspan="2"></td>
								<td  align="justify"><?php echo str_replace(",","<br>",str_replace(", ",",",$nama_usaha)); ?></td>
							</tr>
						</table>
						<br>
