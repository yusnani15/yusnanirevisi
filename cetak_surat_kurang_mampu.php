...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_kurang_mampu where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
...
if (mysqli_num_rows($query_surat)>0){
	...
	$penghasilan_keluarga=$data_surat["penghasilan_keluarga"];
			...
			<?php include("kop_surat.php");?>
				<table width="590" border="0" align="center" cellpadding="3" cellspacing="3">
				  <tr>
					...
					<center>
						<u><b>SURAT KETERANGAN KURANG MAMPU</b></u><br>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="6">
							...
							<tr>
								<td valign="top">2.</td>
								<td  align="justify">
									Turut diterangkan bahwa nama tersebut diatas benar-benar Berpenghasilan Rendah dan tergolong Keluarga Kurang Mampu.
								</td>
							</tr>
						</table>
						<br>
