...
<?php
include("koneksi.php");
$query_surat =mysqli_query($db,"select * from tb_surat_belum_menikah where nomor='".$_GET["nomor"]."'");
$nomor="-";	
$tanggal="-";
$periode="-";
$nik="-";
					...
					<center>
						...
						<table width="100%" border="0" align="center" cellpadding="3" cellspacing="6">
							...
							<tr>
								<td valign="top">2.</td>
								<td  align="justify">
									Turut kami terangkan bahwa menurut Daftar Kependudukan di Kantor Pangulu Nagori Perasmian dan sepanjang pengatahuan
									kami bahwa nama tersebut diatas <b><u>BELUM PERNAH MENIKAH</u></b>.
								</td>
							</tr>
						</table>
						<br>
