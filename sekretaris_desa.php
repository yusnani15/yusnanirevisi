...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	...
	<td width="20%"  bgcolor="white" align="right"><a href="?page=sekretaris_desa"><font color="red">X</font></a>
	</td>
  </tr>
</table>
...
if (@$_POST['btnsimpan']){
	...
	if (mysqli_num_rows($query)>0){
		...
		echo "<script>alert('data tersimpan');document.location='?page=sekretaris_desa';</script>";
	}
	...
	if (mysqli_num_rows($query)>0){
		...
		$_SESSION["SD_status"]="";
		$_SESSION["SD_kata_sandi"]="";
		echo "<script>alert('data diedit');document.location='?page=sekretaris_desa'</script>";
	}
		...
		$_SESSION["SD_status"]="";
		$_SESSION["SD_kata_sandi"]="";
		echo "<script>alert('data telah dihapus');document.location='?page=sekretaris_desa';</script>";
		...
		$_SESSION["SD_status"]="";
		$_SESSION["SD_kata_sandi"]="";
		echo "<script>document.location='?page=sekretaris_desa&aksi=tambah';</script>";
