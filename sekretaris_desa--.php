...
if (!@$_SESSION['pswd']){
	...
	echo "<script>document.location='?page=sekretaris_desa';</script>";
}
if (@$_GET['pswd']=='lihat'){
...
<?php
$query_urut=mysqli_query($db,"select * from tb_sekretaris_desa order by nik desc");
$urut=0;
...
if(@$_POST['cari']){
		echo"<script>document.location='?page=sekretaris_desa&cari=".$_POST["cari"]."';</script>";	
}?>

<?php if (@$_GET['aksi']=='edit'){
	$query_edit=mysqli_query($db,"select * from tb_sekretaris_desa where nik='".$_GET['nik']."'");
	...
	$_SESSION["SD_Nagori"]=$data_edit["Nagori"];
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Edit Sekretaris Desa
	</td>
	...
	<td bgcolor="" valign="top">
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
			  ...
			  <td valign="top">:</td>
			  <td>
				<select id="Nagori" name="Nagori"/>
					<option <?php if (@$_SESSION["SD_Nagori"]=="Perasmian"){ echo "selected"; } ?>/>Perasmian</option>
				</select>
			  </td>
			</tr>
			<tr>
			...
			<tr>
				...
				<a href="?page=sekretaris_desa&aksi=batal_ubah"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
      </table>
    </td>
...
<?php }elseif (@$_GET['aksi']=='hapus'){
	$query_hapus=mysqli_query($db,"select * from tb_sekretaris_desa where nik='".$_GET['nik']."'");
	...
	$_SESSION["SD_Nagori"]=$data_hapus["Nagori"];
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Yakin ingin menghapus data Sekretaris Desa berikut?
	</td>
	<td width="20%"  bgcolor="white" align="right"><a href="?page=sekretaris_desa_bendahara"><font color="red">X</font></a>
	</td>
  </tr>
	...
	<td bgcolor="" valign="top">
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
			  <td valign="top">Nagori</td>
			  <td valign="top">:</td>
			  <td> <?php echo @$_SESSION["SD_Nagori"]; ?></td>
			</tr>
			<tr>
			  <td valign="top">Kecamatan</td>
			  <td valign="top">:</td>
			...
			<tr>
				<td height="36" colspan="3" bgcolor="#ffffcc" align="left">
				<a href="?page=sekretaris_desa&aksi=hapus&nik=<?php echo $_GET['nik']; ?>&pesan=ya"><input type="button" name="button2" id="button2" value="Hapus" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				<a href="?page=sekretaris_desa&aksi=batal_hapus"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
      </table>
    </td>
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Tambah Sekretaris Desa
	</td>
	<td width="20%"  bgcolor="white" align="right"><a href="?page=sekretaris_desa_bendahara"><font color="red">X</font></a>
	</td>
  </tr>
		...
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
				<td height="36" colspan="3" bgcolor="" align="left">
					...
					<a href="?page=sekretaris_desa&aksi=batal_tambah"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
		</table>
    </td>
...
if(@$_GET['cari']){
	$query =mysqli_query($db,"select * from tb_sekretaris_desa where nik like '%".$_GET['cari']."%' or nama like '%".$_GET['cari']."%' order by nik asc");
}elseif(@$_GET['nik']){
	$query =mysqli_query($db,"select * from tb_sekretaris_desa where nik like '%".$_GET['nik']."%' order by nik asc");
}else{
	$query=mysqli_query($db,"select * from tb_sekretaris_desa order by nik asc");	
}
...
if (@$_POST['btnsimpan']){
	...
	$_SESSION["SD_Nagori"]=$_POST["Nagori"];
	...
	$query=mysqli_query($db,"select * from tb_sekretaris_desa where nik='".$_POST['nik']."'");
	if (mysqli_num_rows($query)>0){
		echo"<script>alert('nik yang sama sudah ada');document.location='?page=sekretaris_desa&aksi=tambah';</script>";
	}else{
		mysqli_query($db,"insert into tb_sekretaris_desa (nik,nama,tempat_lahir,tanggal_lahir,alamat,kode_pos,rt_rw,Nagori,kecamatan,kabupaten,provinsi,agama,status_perkawinan,Kewarganegaraan,telepon,status,kata_sandi) values ('". $_SESSION["SD_nik"] ."','". $_SESSION["SD_nama"] ."','". $_SESSION["SD_tempat_lahir"] ."','". $tgl_benar ."','". $_SESSION["SD_alamat"] ."','". $_SESSION["SD_kode_pos"] ."','". $_SESSION["SD_rt_rw"] ."','". $_SESSION["SD_Nagori"] ."','". $_SESSION["SD_kecamatan"] ."','". $_SESSION["SD_kabupaten"] ."','". $_SESSION["SD_provinsi"] ."','". $_SESSION["SD_agama"] ."','". $_SESSION["SD_status_perkawinan"] ."','". $_SESSION["SD_Kewarganegaraan"] ."','". $_SESSION["SD_telepon"] ."','". $_SESSION["SD_status"] ."','". $_SESSION["SD_kata_sandi"] ."')");
		$_SESSION["SD_nik"]="";
		$_SESSION["SD_nama"]="";
		...
		echo "<script>alert('data tersimpan');document.location='?page=sekretaris_desa_bendahara';</script>";
	}
	...
	$_SESSION["SD_status"]=$_POST["status"];
	$_SESSION["SD_kata_sandi"]=$_POST["kata_sandi"];
	$query=mysqli_query($db,"select * from tb_sekretaris_desa where nik='".$_POST['nik']."' and nik<>'".$_GET['nik']."'");
	if (mysqli_num_rows($query)>0){
		echo"<script>alert('Kode persyaratan pelanggan yang sama sudah ada');document.location='?page=sekretaris_desa';</script>";
	}else{
		mysqli_query($db,"update tb_sekretaris_desa set nik='". $_SESSION["SD_nik"] ."',nama='". $_SESSION["SD_nama"] ."',tempat_lahir='". $_SESSION["SD_tempat_lahir"] ."',tanggal_lahir='". $tgl_benar ."',alamat='". $_SESSION["SD_alamat"] ."',kode_pos='". $_SESSION["SD_kode_pos"] ."',rt_rw='". $_SESSION["SD_rt_rw"] ."',Nagori='". $_SESSION["SD_Nagori"] ."',kecamatan='". $_SESSION["SD_kecamatan"] ."',kabupaten='". $_SESSION["SD_kabupaten"] ."',provinsi='". $_SESSION["SD_provinsi"] ."',agama='". $_SESSION["SD_agama"] ."',status_perkawinan='". $_SESSION["SD_status_perkawinan"] ."',kewarganegaraan='". $_SESSION["SD_kewarganegaraan"] ."',telepon='". $_SESSION["SD_telepon"] ."',status='". $_SESSION["SD_status"] ."',kata_sandi='". $_SESSION["SD_kata_sandi"] ."' where nik='".$_GET['nik']."'");
		...
		mysqli_query($db,"delete from tb_sekretaris_desa where nik='".$_GET['nik']."'");
		$_SESSION["SD_nik"]="";
		$_SESSION["SD_nama"]="";
		$_SESSION["SD_tempat_lahir"]="";
		$_SESSION["SD_tanggal_lahir"]="";
