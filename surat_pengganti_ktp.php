...
if (!@$_SESSION['pswd']){
	...
	echo "<script>document.location='?page=surat_pengganti_ktp';</script>";
}
if (@$_GET['pswd']=='lihat'){
...
<?php
if(@$_POST['cari']){
		echo"<script>document.location='?page=surat_pengganti_ktp&cari=".$_POST["cari"]."';</script>";
}?>

<?php if (@$_GET['aksi']=='edit'){
	$query_edit=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor='".$_GET['nomor']."'");
	...
	$_SESSION["SD_lokasi_hilang"]=$data_edit["lokasi_hilang"];
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Edit Surat Keterangan Penganti KTP
	</td>
	<td width="20%"  bgcolor="white" align="right"><a href="?page=surat_pengganti_ktp"><font color="red">X</font></a>
	</td>
  </tr>
</table>
  ...
  <tr>
	<td bgcolor="" valign="top">
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
			  <td valign="top">Lokasi Hilang</td>
			  <td valign="top">:</td>
			  <td><input type="text" name="lokasi_hilang" id="lokasi_hilang" maxlength="200" value="<?php echo @$_SESSION["SD_lokasi_hilang"]; ?>" required style="width:150px"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td valign="top"><label for="gambar"></label>
					...
					<br>
					<img src="Img_Alumni/<?php echo "pengganti_ktp_ktp_".$data_edit['nomor'].".jpg"; ?>" width="100" />
				</td>
			</tr>
			<tr>
				<td valign="top">KK</td>
				...
				<td valign="top"><label for="gambar"></label>
					...
					<br>
					<img src="Img_Alumni/<?php echo "pengganti_ktp_kk_".$data_edit['nomor'].".jpg"; ?>" width="100" />
				</td>
			</tr>
			<tr>
				...
				<a href="?page=surat_pengganti_ktp&aksi=batal_ubah"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
      </table>
    </td>
...
<?php }elseif (@$_GET['aksi']=='hapus'){
	$query_hapus=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor='".$_GET['nomor']."'");
	...
	$_SESSION["SD_lokasi_hilang"]=$data_hapus["lokasi_hilang"];
	$_SESSION["SD_pekerjaan"]=$data_hapus["pekerjaan"];
?> 

<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Yakin ingin menghapus data Surat Keterangan Penganti KTP berikut?
	</td>
	<td width="20%"  bgcolor="white" align="right"><a href="?page=surat_pengganti_ktp"><font color="red">X</font></a>
	</td>
  </tr>
	...
	<td bgcolor="" valign="top">
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
			  <td valign="top">Lokasi Hilang</td>
			  <td valign="top">:</td>
			  <td><?php echo @$_SESSION["SD_lokasi_hilang"]; ?></td>
			</tr>
			<tr>
			  <td valign="top">Pekerjaan</td>
			  <td valign="top">:</td>
			...
			<tr>
				<td height="36" colspan="3" bgcolor="#ffffcc" align="left">
				<a href="?page=surat_pengganti_ktp&aksi=hapus&nomor=<?php echo $_GET['nomor']; ?>&pesan=ya"><input type="button" name="button2" id="button2" value="Hapus" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				<a href="?page=surat_pengganti_ktp&aksi=batal_hapus"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
      </table>
    </td>
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Tambah Surat Keterangan Penganti KTP
	</td>
	<td width="20%"  bgcolor="white" align="right"><a href="?page=surat_pengganti_ktp"><font color="red">X</font></a>
	</td>
  </tr>
...
$nomor_surat=0;
$query_domisili=mysqli_query($db,"select * from tb_surat_pengganti_ktp order by nomor desc");
	...
	<td bgcolor="" valign="top">
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="3" bgcolor="WHITE">
			...
			<tr>
				<td valign="top">Lokasi Hilang</td>
				<td valign="top">:</td>
				<td><input type="text" name="lokasi_hilang" id="lokasi_hilang" maxlength="200" value="<?php echo @$_SESSION["SD_lokasi_hilang"]; ?>" required style="width:350px"/></td>
			</tr>
			<tr>
				<td valign="top">Pekerjaan</td>
				<td valign="top">:</td>
			...
			<tr>
				<td height="36" colspan="3" bgcolor="" align="left">
					...
					<a href="?page=surat_pengganti_ktp&aksi=batal_tambah"><input type="button" name="button2" id="button2" value="Batal" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
				</td>
			</tr>
		</table>
    </td>
...
<table width="99%" border="0" align="center" cellpadding="6" cellspacing="0" style="border: solid 2px #6c6969">
  <tr>
	<td width="80%"  bgcolor="white" >Surat Keterangan Penganti KTP
		<?php if (@$_SESSION["yusnani_status"]=="Penduduk" or @$_SESSION["yusnani_status"]=="Sekretaris Desa"){ ?>
			<a href="?page=surat_pengganti_ktp&aksi=tambah"><input type="button" name="button" id="button2" value="+ Tambah" <?php echo "style='width:160px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
		<?php } ?>
	</td>
  </tr>
</table>
...
if (@$_SESSION["yusnani_status"]=="Sekretaris Desa"){
	$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp order by nomor asc");	
	if(@$_GET['cari']){
		$query =mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor like '%".$_GET['cari']."%' or nama like '%".$_GET['cari']."%' order by nomor asc");
	}elseif(@$_GET['nomor']){
		$query =mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor like '%".$_GET['nomor']."%' order by nomor asc");
	}else{
		$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp order by nomor asc");	
	}	
}elseif (@$_SESSION["yusnani_status"]=="Penduduk"){
	$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nik='".$_SESSION["yusnani_nik"]."' order by nomor asc");	
	if(@$_GET['cari']){
		$query =mysqli_query($db,"select * from tb_surat_pengganti_ktp where nik='".$_SESSION["yusnani_nik"]."'and (nomor like '%".$_GET['cari']."%' or nama like '%".$_GET['cari']."%') order by nomor asc");
	}elseif(@$_GET['nomor']){
		$query =mysqli_query($db,"select * from tb_surat_pengganti_ktp where nik='".$_SESSION["yusnani_nik"]."' and (nomor like '%".$_GET['nomor']."%') order by nomor asc");
	}else{
		$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nik='".$_SESSION["yusnani_nik"]."' order by nomor asc");	
	}		
}
            ...
            <td width="100%" bgcolor="#6c6969"  background="img/blk.jpg" align="center">
              ...
              <tr>
                ...
                <td align="center" <?php echo $btsklm; ?>>
					<?php
					echo "KK :<a href='img/file/pengganti_ktp_kk_".$data['nomor'].".jpg' target='_blank'>kk_".$data['nomor'].".jpg</a><br>";
					echo "KTP :<a href='img/file/pengganti_ktp_ktp_".$data['nomor'].".jpg' target='_blank'>ktp_".$data['nomor'].".jpg</a>";
					?>				
				</td>
                ...
                <td align="center" <?php echo $btsklm; ?>>
					<?php if (@$_SESSION["yusnani_status"]=="Penduduk"){?>
						<?php if ($data["status"]=="Belum Divalidasi"){?>
							<!--<a href="?page=surat_pengganti_ktp&aksi=cetak&nomor=<?php echo $data['nomor']; ?>"><input type="button" name="btnlogin" id="btnlogin" value="Cetak" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>-->
							<a href="?page=surat_pengganti_ktp&aksi=hapus&nomor=<?php echo $data['nomor']; ?> "><input type="button" name="btnlogin" id="btnlogin" value="Hapus" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
						<?php } ?>
						<?php if ($data["status"]=="Telah Divalidasi"){?>
							<a href="cetak_surat_pengganti_ktp.php?aksi=cetak&nomor=<?php echo $data['nomor']; ?>" target="_blank"><input type="button" name="btnlogin" id="btnlogin" value="Cetak" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
							<!--<a href="?page=surat_pengganti_ktp&aksi=hapus&nomor=<?php echo $data['nomor']; ?> "><input type="button" name="btnlogin" id="btnlogin" value="Hapus" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>-->
						<?php } ?>
					...
					<?php if (@$_SESSION["yusnani_status"]=="Sekretaris Desa"){?>
						<?php if ($data["status"]=="Belum Divalidasi"){?>
							<a href="cetak_surat_pengganti_ktp.php?aksi=cetak&nomor=<?php echo $data['nomor']; ?>" target="_blank"><input type="button" name="btnlogin" id="btnlogin" value="Cek Surat" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
							<a href="?page=surat_pengganti_ktp&aksi=validasi&nomor=<?php echo $data['nomor']; ?>"><input type="button" name="btnlogin" id="btnlogin" value="Validasi" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
							<a href="?page=surat_pengganti_ktp&aksi=tolak&nomor=<?php echo $data['nomor']; ?> "><input type="button" name="btnlogin" id="btnlogin" value="Tolak" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
						<?php } ?>
						<?php if ($data["status"]=="Telah Divalidasi"){?>
							<a href="cetak_surat_pengganti_ktp.php?aksi=cetak&nomor=<?php echo $data['nomor']; ?>" target="_blank"><input type="button" name="btnlogin" id="btnlogin" value="Cetak" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>
							<!--<a href="?page=surat_pengganti_ktp&aksi=validasi&nomor=<?php echo $data['nomor']; ?>"><input type="button" name="btnlogin" id="btnlogin" value="Validasi" <?php echo "style='width:100px;background-color:".$btnbgcolor.";height:30px;color:".$btntextcolor.";'"; ?>/></a>-->
...
if (@$_POST['btnsimpan']){
	...
	$_SESSION["SD_lokasi_hilang"]=$_POST["lokasi_hilang"];
	...
	if($_SESSION["SD_nik"]==""){
		...
		echo"kosong<br>";
		$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor='".$_POST['nomor']."'");
		if (mysqli_num_rows($query)>0){
			echo"<script>alert('nomor yang sama sudah ada');document.location='?page=surat_pengganti_ktp&aksi=tambah';</script>";
		}else{
			$lokasi_file_ktp_lama="img/file/pengganti_ktp_ktp_".$_SESSION["SD_nomor"].".jpg";
			unlink("$lokasi_file_ktp_lama");
			$lokasi_file_ktp=$_FILES['gambar_ktp']['tmp_name'];
			$lokasi_upload_ktp="img/file/pengganti_ktp_ktp_".$_SESSION['SD_nomor'].".jpg";
			copy($lokasi_file_ktp,$lokasi_upload_ktp);

			$lokasi_file_kk_lama="img/file/pengganti_ktp_kk_".$_SESSION["SD_nomor"].".jpg";
			unlink("$lokasi_file_kk_lama");
			$lokasi_file_kk=$_FILES['gambar_kk']['tmp_name'];
			$lokasi_upload_kk="img/file/pengganti_ktp_kk_".$_SESSION['SD_nomor'].".jpg";
			copy($lokasi_file_kk,$lokasi_upload_kk);
								
			mysqli_query($db,"insert into tb_surat_pengganti_ktp (nomor,tanggal,nik,alamat,lokasi_hilang,pekerjaan,status) values ('". $_SESSION["SD_nomor"] ."','".date("Y/m/d")."','". $_SESSION["SD_nik"] ."','". $_SESSION["SD_alamat"] ."','". $_SESSION["SD_lokasi_hilang"] ."','". $_SESSION["SD_pekerjaan"] ."','Belum Divalidasi')");
			$_SESSION["SD_nomor"]="";
			$_SESSION["SD_nik"]="";
			$_SESSION["SD_nama"]="";
			...
			$_SESSION["SD_alamat"]="";
			$_SESSION["SD_lokasi_hilang"]="";
			$_SESSION["SD_pekerjaan"]="";
			echo "<script>alert('data tersimpan');document.location='?page=surat_pengganti_ktp';</script>";
		}
	}
	...
	if($_SESSION["SD_nik"]==""){
		...
		$query=mysqli_query($db,"select * from tb_surat_pengganti_ktp where nomor='".$_POST['nomor']."' and nomor<>'".$_GET['nomor']."'");
		if (mysqli_num_rows($query)>0){
			echo"<script>alert('Nomor surat yang sama sudah ada');document.location='?page=surat_pengganti_ktp';</script>";
		}else{

			$lokasi_file_ktp_lama="img/file/pengganti_ktp_ktp_".$_GET["nomor"].".jpg";
			unlink("$lokasi_file_ktp_lama");
			$lokasi_file_ktp=$_FILES['gambar_ktp']['tmp_name'];
			$lokasi_upload_ktp="img/file/pengganti_ktp_ktp_".$_SESSION['SD_nomor'].".jpg";
			copy($lokasi_file_ktp,$lokasi_upload_ktp);

			$lokasi_file_kk_lama="img/file/pengganti_ktp_kk_".$_GET["nomor"].".jpg";
			unlink("$lokasi_file_kk_lama");
			$lokasi_file_kk=$_FILES['gambar_kk']['tmp_name'];
			$lokasi_upload_kk="img/file/pengganti_ktp_kk_".$_SESSION['SD_nomor'].".jpg";
			copy($lokasi_file_kk,$lokasi_upload_kk);
			
			mysqli_query($db,"update tb_surat_pengganti_ktp set nomor='". $_SESSION["SD_nomor"] ."',nik='". $_SESSION["SD_nik"] ."',tanggal='". $tgl_benar ."',alamat='". $_SESSION["SD_alamat"] ."',lokasi_hilang='". $_SESSION["SD_lokasi_hilang"] ."',pekerjaan='". $_SESSION["SD_pekerjaan"] ."' where nomor='".$_GET['nomor']."'");
			$_SESSION["SD_nomor"]="";
			$_SESSION["SD_nik"]="";
			$_SESSION["SD_nama"]="";
			...
			$_SESSION["SD_lokasi_hilang"]="";
			$_SESSION["SD_pekerjaan"]="";
			echo "<script>alert('data diedit');document.location='?page=surat_pengganti_ktp'</script>";
		}
	}
		...
		mysqli_query($db,"delete from tb_surat_pengganti_ktp where nomor='".$_GET['nomor']."'");
		$_SESSION["SD_nomor"]="";
		$_SESSION["SD_nik"]="";
		$_SESSION["SD_nama"]="";
		$_SESSION["SD_jenis_kelamin"]="";
		...
		$_SESSION["SD_kewarganegaraan"]="";
		$_SESSION["SD_lokasi_hilang"]="";
		echo "<script>alert('data telah dihapus');document.location='?page=surat_pengganti_ktp';</script>";
}elseif (@$_GET['aksi']=='validasi'){
		mysqli_query($db,"update tb_surat_pengganti_ktp set tanggal_disetujui='".date("Y-m-d")."',status='Telah Divalidasi' where nomor='".$_GET['nomor']."'");
		$_SESSION["SD_nomor"]="";
		$_SESSION["SD_nik"]="";
		$_SESSION["SD_nama"]="";
		$_SESSION["SD_jenis_kelamin"]="";
		...
		$_SESSION["SD_lokasi_hilang"]="";
		$_SESSION["SD_pekerjaan"]="";
		echo "<script>alert('data telah divalidasi');document.location='?page=surat_pengganti_ktp';</script>";
}elseif (@$_GET['aksi']=='tolak'){
		mysqli_query($db,"update tb_surat_pengganti_ktp set status='Tidak Disetujui' where nomor='".$_GET['nomor']."'");
		$_SESSION["SD_nomor"]="";
		$_SESSION["SD_nik"]="";
		$_SESSION["SD_nama"]="";
		$_SESSION["SD_jenis_kelamin"]="";
		...
		$_SESSION["SD_lokasi_hilang"]="";
		$_SESSION["SD_pekerjaan"]="";
		echo "<script>alert('data tidak disetujui');document.location='?page=surat_pengganti_ktp';</script>";
		...
		$_SESSION["SD_lokasi_hilang"]="";
		$_SESSION["SD_pekerjaan"]="";
		echo "<script>document.location='?page=surat_pengganti_ktp&aksi=tambah';</script>";
